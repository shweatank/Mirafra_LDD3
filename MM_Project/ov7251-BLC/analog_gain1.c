        ...
        while (SDL_PollEvent(&e)) {
            if (e.type == SDL_QUIT) running = 0;
                ...
                switch (e.key.keysym.sym) {
                    ...
                    case SDLK_g:     analogue_gain = clamp(analogue_gain + 5, 0, 255); set_control(fd_ctrl, V4L2_CID_ANALOGUE_GAIN, analogue_gain); break;
                    case SDLK_f:     analogue_gain = clamp(analogue_gain - 5, 0, 255); set_control(fd_ctrl, V4L2_CID_ANALOGUE_GAIN, analogue_gain); break;
