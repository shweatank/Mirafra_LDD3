...
// Module init
static int __init calc_keyboard_init(void)   //static int __init tasklet_init_module(void)
{
    int ret;
...
// Module exit
static void __exit calc_keyboard_exit(void)    //static void __exit tasklet_cleanup_module(void)
{
