...
static irqreturn_t kbd_top_handler(int irq,void *dev_id)
{
	pr_info("kbd_threaded: [TOP HALF] IRQ %d received\n",irq);
	return IRQ_WAKE_THREAD;
}

static irqreturn_t kbd_thread_handler(int irq,void *dev_id)
{
...
static void __exit kbd_irq_exit(void)
{
	...
	pr_info("kbd_threaded: IRQ removed successfully\n");
}
