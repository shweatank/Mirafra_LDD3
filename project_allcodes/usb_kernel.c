...
static const struct proc_ops proc_fops = {
    ...
    .proc_read    = seq_read,         // Standard sequential file read handler
    .proc_lseek   = seq_lseek,        // For repositioning the file offset
    .proc_release = single_release,   // Called when the file is closed
};
