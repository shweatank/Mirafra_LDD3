...
static int __init my_audio_init(void)
{
  ...
  //  snd_pcm_lib_preallocate_pages_for_all(my_pcm, SNDRV_DMA_TYPE_CONTINUOUS,
   ...
   snd_pcm_lib_preallocate_pages_for_all(my_pcm,
    ...
    pr_info("MyAudioCard loaded successfully\n");
    return 0;
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Minimal ALSA Audio Driver for x86");
