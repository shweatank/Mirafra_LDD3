...
#define PCM_DEVICE "plughw:0,7"  // ALSA PCM device for hardware 0, subdevice 0
#define SAMPLE_RATE 44100        // Sample rate: 44.1 kHz
...
int main() {
    ...
    if ((pcm = snd_pcm_open(&playback_handle, "plughw:0,0", SND_PCM_STREAM_PLAYBACK, 0)) < 0) {
