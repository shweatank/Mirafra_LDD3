...
static void my_tasklet_func(struct tasklet_struct *tasklet)
{
	...
	switch(count%4)
	{
		case 0:printk(KERN_INFO "Addition = %d",10+5);
			  break;
		case 1:printk(KERN_INFO"Substraction = %d",10-5);
			  break;
		case 2:printk(KERN_INFO"Multiplication = %d\n",10*5);
			  break;
		case 3:printk(KERN_INFO"Division = %d",10/5);
			  break;
